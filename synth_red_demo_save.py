...
PY = os.path.normpath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "pokered"))
BUILD = "F:/Projects/gbcrecomp/Pokemon Red/generated_ext/build"
YELLOW_BUILD = os.path.join(os.path.dirname(os.path.abspath(__file__)), "recomp", "build")
BASE_SAV = os.path.join(YELLOW_BUILD, "Pokemon_Yellow_Extended.sav.preMovesDemo")  # valid 251-dex Gen1 save (identical layout)
OUT_SAV  = os.path.join(BUILD, "Pokemon_Red_Extended.sav")
BUNDLE   = os.path.join(os.path.dirname(os.path.abspath(__file__)), "dist",
                        "Pokemon_Red_Extended_MovesDemo.sav")
